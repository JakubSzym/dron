...
namespace PzG {
 ...
 //-------------------------------------------------------------------------
 // Informuje, czy poczenie z programem gnuplot zostao zainicjowane.
 // 
...
/*!
 *  Inicjalizuje poczenie z programem \e gnuplot. Realizowane jest to
 ...
 *  poprzez przejcie jego wejcia i wyjcia standardowego.
 *
 *  \retval true - gdy poczenie z programem \e gnuplot zostao poprawnie
 *               zainicjalizowane lub gdy ju wczeniej byo 
 *               zainicjalizowane.
 *  \retval false - gdy proces inicjalizacji poczenia zakoczy si
 *               niepowodzeniem.
 */
...
/*!
 * Tworzy napis bdcy parametrami dla polecenie \e plot programu,
 * \e gnuplot. Parametry te pozwalaj na rysowanie bry, których
 *  wspórzdne wierzchoków zawarte s w plikach.
 *  Nazwy tych plików musz by wczeniej doczone do kolejki 
 ...
 *                  tworzcych parametry dla polecenia \e plot.
 * \param Sep - zawiera znak separatora midzy poszczególnymi
 *              parametrami. Jeeli parametry listy nazw plików
 *              s generowane jako pierwsze, to zmienna ta musi 
 *              by wskanikiem do wskanika na acuch: " ".
 * \retval true - jeli lista nazw plików nie jest pusta.
 * \retval false - w przypadku przeciwnym.
 * \post Jeeli  lista nazw plików nie jest pusta, to poprzez
 *              parametr \e Sep zostaje udostpniony acuch: ", ".
 */
 ...
 //        Metoda nie wymaga wczeniejszego zainicjowania poczenia
 //        z gnuplotem.
 //  POST: true   - gdy zostaja poprawnie wyslane polecenia dla gnuplota.
 //                 Nie oznacza to jednak, ze proces rysowania zakoczy
 //                 si pomylnie.
 //       false   - gdy poczenie z gnuplotem nie moze zostac poprawnie
